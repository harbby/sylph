 ...
 */
package com.github.harbby.sylph.runner.spark.runtime;
...
public final class SparkAppMain
{
            ...
            throws Exception
    {
        ...
        String jobGraphFile = args[0];
        Supplier<?> jobGraph;
        try (InputStream inputStream = new FileInputStream(jobGraphFile)) {
            jobGraph = (Supplier<?>) byteToObject(inputStream);
        }
        Object appContext = requireNonNull(jobGraph, "spark jobGraph is null").get();
