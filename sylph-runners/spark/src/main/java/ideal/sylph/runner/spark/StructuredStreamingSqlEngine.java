        ...
        extends SparkStreamingSqlEngine
{
    ...
    private static Serializable compile(String jobId, SqlFlow sqlFlow,
            OperatorMetaData operatorMetaData, SparkJobConfig sparkJobConfig,
            List<URL> pluginJars)
            throws JVMException
    {
        ...
        final Supplier<SparkSession> appGetter = (Supplier<SparkSession> & Serializable) () -> {
            ...
            //build sql
            SqlAnalyse sqlAnalyse = new StructuredStreamingSqlAnalyse(sparkSession, operatorMetaData, isCompile.get());
            try {
