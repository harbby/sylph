        ...
        implements Record
{
    ...
    public FlinkRecord(org.apache.flink.types.Row row, TypeInformation<org.apache.flink.types.Row> typeInformation)
    {
        this.row = row;
    ...
    public static org.apache.flink.types.Row parserRow(Record record)
    {
